...
#### [`$gn_dir/config/BUILDCONFIG.gn`](config/BUILDCONFIG.gn)
...
#### [`$gn_dir/toolchain/clang.gni`](toolchain/clang.gni)
...
#### [`$gn_dir/toolchain/compiler_version.gni`](toolchain/compiler_version.gni)
...
#### [`$gn_dir/toolchain/win/settings.gni`](toolchain/win/settings.gni)
...
#### [`$gn_dir/toolchain/posix/settings.gni`](toolchain/posix/settings.gni)
...
#### [`$gn_dir/toolchain/mac/settings.gni`](toolchain/mac/settings.gni)
...
* `enable_dsyms` (default: true): Produce dSYM files for targets that are
  ...
  linker output (produced via the `$gn_dir/toolchain/mac/linker_driver.py`.
...
* `enable_stripping` (default: `is_official_build`): Strip symbols from linked
  targets by default. If this is enabled, the $gn_dir/config/mac:strip_all
  ...
  `-Wcrl,strip` flags. See $gn_dir/toolchain/mac/linker_driver.py for more
  information.

#### [`$gn_dir/toolchain/mac/mac_sdk.gni`](toolchain/mac/mac_sdk.gni)
...
#### [`$gn_dir/toolchain/mac/ios_sdk.gni`](toolchain/mac/ios_sdk.gni)
...
#### [`$gn_dir/toolchain/android/settings.gni`](toolchain/android/settings.gni)
...
that just `import()s` [`$gn_dir/config/BUILDCONFIG.gn`](config/BUILDCONFIG.gn) and then overrides
